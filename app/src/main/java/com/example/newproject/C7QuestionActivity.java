...
public class C7QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c7_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("A pakage must contain :", "Two create files", "At least one create", "No create file", 2));
        questionList.add(new Question("Which of the given option is a Binnary create: ", "src/main.rs", "src/lib.rs", "src/toml.rs", 2));
        questionList.add(new Question("Which create is used to generate random numbers:", "Rand", "Ramdom", "Random16.5", 1));
        questionList.add(new Question("What is the work of use key-word:", "Used in create", "Brings path into scope", "Brings a path out of scope", 2));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C7QuestionActivity.this.finish();
