...
public class C10QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c10_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("We use generics to create definitions for items like:", "function signatures or structs", "loops and functions", "Enums and Hashmaps", 1));
        questionList.add(new Question("std::cmp::PartialOrd, The given pakage is :", "Trait", "Enum ", "Libarary", 1));
        questionList.add(new Question("'impl'  keyword is used for :", "Appliying implementation box", "Implementing value on a variable", "Implementing enum blocks ", 1));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C10QuestionActivity.this.finish();
