...
public class C8QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c8_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("In Rust, What is known as collection:", "Useful data structure", "Collection of dependencies", "Collection of files", 1));
        questionList.add(new Question("What is the purpose of vector,allows us to store : ", "number next to each other", "key and value", "data in hashmap", 1));
        questionList.add(new Question("A match expression is a very useful but also alos very much:", "Primitive", "Secondary", "Primary", 1));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C8QuestionActivity.this.finish();
