...
public class C2QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("To set up a new project,which command is used:", "CD New File_name", "cargo new file_name", "Cargo New_File_Name", 2));
        questionList.add(new Question("Which file contain dependencies", "cargo.toml file", "cargo --version", "cargo--build", 1));
        questionList.add(new Question("The first part of the guessing game program will ask for: ", "User input", "Compilation", "Run", 1));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C2QuestionActivity.this.finish();
