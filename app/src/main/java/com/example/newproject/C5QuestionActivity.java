...
public class C5QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c5_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question(" Structs are similar to:", "Enums", "Fields", "Tuples", 1));
        questionList.add(new Question("Functions are represented with fn keyword and have:", "parameters and return values", "no values", "value always 10", 1));
        questionList.add(new Question("Functions can have which of the following : ", "Value", "Implementation block", "Both", 3));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C5QuestionActivity.this.finish();
