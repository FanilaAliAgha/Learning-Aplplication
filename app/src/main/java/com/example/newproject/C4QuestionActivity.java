...
public class C4QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question(" I2C protocol uses model", "Master Slave", "Slave Master", "Master Master", 1));
        questionList.add(new Question("All data stored on the stack must have :", "size=10", "size =10000", "Fixed size", 3));
        questionList.add(new Question("The double colon (::) is an operator that allows us to write : ", "namespace", "characterspace", "numberspace", 1));
        setQuestion();
