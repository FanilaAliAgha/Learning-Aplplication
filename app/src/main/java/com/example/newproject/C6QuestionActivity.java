...
public class C6QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c6_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question(" Select only true statements from following, Enum varent can have : ", "array like data", "Field-like data", "Struct-like data", 3));
        questionList.add(new Question("Which of the following is correct statement about enums: ", "Always has variants", "Never have values", "It is algebraic data types", 1));
        questionList.add(new Question("Rust also has a pattern we can use when we don’t want to list all possible values: ", "Placeholder", "array list", "Refferencing", 1));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C6QuestionActivity.this.finish();
