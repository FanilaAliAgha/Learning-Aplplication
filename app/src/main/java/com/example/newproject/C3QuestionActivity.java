...
public class C3QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("What is used when a function needs to mutate the value without consuming it in implementation block:", "self", "self mut", "mut self", 1));
        questionList.add(new Question("Rust syntax is similar to which programming Language:", "C++", "C", "Python", 2));
        questionList.add(new Question("Select only true statements from following,about Rust compiler: ", "Seems slow", "Doesn't seems slow", "Moderate", 2));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C3QuestionActivity.this.finish();
