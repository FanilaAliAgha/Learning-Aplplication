...
public class C1QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c1_question);
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("Rust uses which print macro:", "println!", "Println", "printf", 1));
        questionList.add(new Question("To check the version of Rust we use:", "cargo-- Build", "cargo --version", "Cargo--Toml", 2));
        questionList.add(new Question("Println! is a:", "Framework", "Function", "Macro", 3));
        setQuestion();
...
//            }
    ...
    private void changeQuestion() {
        ...
        else
        {
            ...
            C1QuestionActivity.this.finish();
